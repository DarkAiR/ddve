...
<link href="http://www.ddve.ru/templates/catalog/css/mail.css" rel="stylesheet" type="text/css" />
</head>
...
if( !empty($_POST) )
{
   ...
   echo '<div style="display:none" id="hello">';
...
<table width="100%" cellpadding=0 cellspacing=2 border=0>
        <tr>
                ...
                <td></td>
                <td>
                  <img src="make.php/?<?php echo session_name()?>=<?php echo session_id()?>">
