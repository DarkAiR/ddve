...
if( $show_top_navigation ) {
	?>
	<!-- DarkAiR &nbsp;&nbsp;&nbsp;&nbsp;<?php echo $VM_LANG->_('PN_DISPLAY_NR') ?>&nbsp;&nbsp; -->
    
	<?php //DarkAiR $pagenav->writeLimitBox(); ?>
	<!-- DarkAiR noscript><input type="submit" value="<?php echo $VM_LANG->_('PHPSHOP_SUBMIT') ?>" /></noscript-->
