...
class embediaDivX extends embediaPlayerBase 
{
	/**
	...
	protected function setupAttributes( )
	{
		...
		$this->paramAttributes = $this->generateAttributeValuesArray(array('console', 'url', 'src', 'filename', 'width', 'height', 'autoplay', 'mode', 'allowcontextmenu', 'loop', 'bufferingmode', 'previewimage', 'previewmessage', 'custommode'));
		//additional..
		...
		$this->embedAttributes = $this->generateAttributeValuesArray(array('name', 'console', 'url', 'src', 'filename', 'width', 'height', 'type',  'autoplay', 'mode', 'allowcontextmenu', 'loop', 'bufferingmode', 'previewimage', 'previewmessage', 'custommode'));
		//additional..
		$this->embedAttributes['url'] = $this->mediaPath;
		$this->embedAttributes['src'] = $this->mediaPath;
		$this->embedAttributes['console'] = $this->mediaPath;
		$this->embedAttributes['name'] = $this->uniqueID;
	}
	
	/**
	 * Function for embedding the audio files associated with DivX
