...
class embediaJWMediaPlayer extends embediaPlayerBase
{
	/**
	...
	protected function setupAttributes( )
	{
		...
		$this->embedAttributes = $this->generateAttributeValuesArray(array('name', 'id', 'src', 'width', 'height', 'type', 'pluginspage', 'wmode', 'allowscriptaccess'));
		//additional..
